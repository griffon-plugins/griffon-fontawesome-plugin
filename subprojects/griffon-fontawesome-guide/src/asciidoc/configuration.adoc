...
----
dependencies {
    griffon '{groupId}:griffon-fontawesome-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{groupId}:griffon-fontawesome-swing:{project-version}'
}
----
...
----
dependencies {
    compile '{groupId}:griffon-fontawesome-javafx:{project-version}'
}
----
...
----
dependencies {
    compile '{groupId}:griffon-fontawesome-swing-groovy:{project-version}'
}
----
...
----
dependencies {
    compile '{groupId}:griffon-fontawesome-javafx-groovy:{project-version}'
}
----
