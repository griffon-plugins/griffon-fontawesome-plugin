...
:package-base: org/codehaus/griffon/runtime/fontawesome
:numbered:
...
----
include::{subproject-base}javafx-groovy{groovy-source}{package-base}/FontAwesomeJavaFXGroovyModule.java[tags=bindings,indent=0]
----
...
[source,java,options="nowrap"]
----
include::{subproject-base}swing-groovy{java-source}{package-base}/FontAwesomeSwingGroovyModule.java[tags=bindings,indent=0]
----
